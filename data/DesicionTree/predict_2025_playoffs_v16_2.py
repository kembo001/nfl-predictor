...
def prepare_2025_game_features(matchup, team_df_2025, epa_model, baselines):
    ...
    # v16.2 spread features (no spread for 2025 predictions)
...
def main():
    ...
    # v16.2 Feature columns (includes has_spread and tossup_baseline)
    ...
    # Train models (v16.2: ridge on baseline only)
    ...
    # v16.2: XGBoost(full) for stability
    xgb_model = None
    if HAS_XGBOOST:
    ...
    print(f"\nv16.2 Parameters:")
    print(f"  λ_base={lambda_base}, XGB weight={xgb_weight}")
    print(f"  Adjustment cap={adj_cap}, Tossup shrink={tossup_shrink}")
    ...
    print("\n" + "=" * 80)
    print("2025 NFL PLAYOFF PREDICTIONS (v16.2)")
    print("=" * 80)
    ...
    for away, home, conf in wc_matchups:
        ...
        pred = predict_ensemble_v16_2(model_dict, game_feats, xgb_model, xgb_weight, lambda_base, adj_cap, tossup_shrink)
